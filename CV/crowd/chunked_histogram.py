...
###Can be "head_sum", "head_avg", "people_sum", or "people_avg"
ATTRIBUTE = "head_avg"
###Can be "category", "production", "year", or "type"
GROUPING = "category"
###Can be "chunk_cen", "chunk_start" or "chunk_end"
X_AXIS = "chunk_cen"
...
#tarpath = "../crowd_narrative_feature_musical_chunked.csv"
#if not ANIMATE:
#    tarpath = "../crowd_narrative_chunked_nonchn.csv"
#	tarpath = "CV/crowd_narrative_chunked_all_but_pri.csv"
tarpath = "CV/crowd_narrative_feature_musical_chunked_sec.csv"
...
if not ANIMATE:
	fig = px.histogram(df, x=X_AXIS, y=ATTRIBUTE, histfunc='avg', color=GROUPING, hover_name="title", hover_data=["title","chunk_start"], title="{} Distributed in {}Films".format(cap, "All " if TYPE_FILTER is None else f"{TYPE_FILTER} ")
                    ,
					color_discrete_map = {
	...
	fig.update_layout(yaxis_title="Average Head Count", legend_title="Category", xaxis_title="Time Segment in Film", title_x=0.5)
